...
### Glossary (`lib/abecedaire.ts`)
108 entries. Each entry: `{ id, term, definition, category, sources?, relatedTerms?, relatedDbThreshold? }`. Categories: `acoustic | health | social | legal | environmental`.
